...
const kAuthBg = Color(0xFF0A0A0C);
const kAuthPanel = Color(0xFF121214);
const kAuthInputBg = Color(0xFF1A1A1E);
const kAuthGold = Color(0xFFD6A85A);
const kAuthGoldDark = Color(0xFFE5B869);
const kAuthText = Color(0xFFFFFFFF);
const kAuthMuted = Color(0xFF9CA3AF);
const kAuthBorder = Color(0xFF2D2D32);
const kAuthDivider = Color(0xFF26262B);
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  String get _fullPhoneNumber =>
      sanitizePhoneNumber('+${_selectedCountry.phoneCode}${_phoneCtrl.text.replaceAll(RegExp(r'\D'), '')}');
      ...
      body: AnimatedPadding(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final heroHeight =
                (constraints.maxHeight * (_isLogin ? 0.45 : 0.35)).clamp(
              _isLogin
                  ? (isCompactHeight ? 270.0 : 300.0)
                  : (isCompactHeight ? 210.0 : 240.0),
              _isLogin
                  ? (isCompactHeight ? 350.0 : 390.0)
                  : (isCompactHeight ? 280.0 : 320.0),
            );
    ...
    return Column(
      ...
      children: [
        ...
        _LuxuryInput(
          ...
          prefix: const Icon(LucideIcons.lock, color: kAuthGoldDark, size: 21),
          suffix: IconButton(
            onPressed: () =>
                ...
                child: Row(
                  children: [
                    AnimatedContainer(
                      ...
                      height: 22,
                      decoration: BoxDecoration(
                        color: _rememberMe ? kAuthGoldDark : Colors.transparent,
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(
                          color: _rememberMe ? kAuthGoldDark : kAuthBorder,
                        ),
                      ),
                      child: _rememberMe
                          ? const Icon(
    ...
    return Column(
      ...
      children: [
        ...
        _LuxuryInput(
          ...
          prefix: const Icon(LucideIcons.user, color: kAuthGoldDark, size: 21),
          onChanged: (_) => setState(() {}),
          dense: true,
        ),
          ...
          children: [
            ...
            Expanded(
              ...
              child: _LuxuryInput(
                ...
                prefix:
                    const Icon(LucideIcons.phone, color: kAuthGoldDark, size: 21),
                onChanged: (_) => setState(() {}),
                dense: true,
              ),
            ),
        ...
        child: Container(
          ...
          child: SafeArea(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                final padding =
                    EdgeInsets.fromLTRB(20, 16, 20, bottomInset + 16);
